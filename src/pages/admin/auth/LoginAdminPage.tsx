...
export interface LoginAdminFormData {
  username: string;
  password: string;
  isRemember: boolean;
}
...
const LoginAdminPage = () => {
  const [login, { data, isError, isSuccess, error }] = useLoginAdminMutation();
  ...
  const onSubmit: SubmitHandler<LoginAdminFormData> = (data) => {
    login(data);
  };
  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-gray-50">
      <form
        ...
        className="flex flex-col gap-6 w-[460px] max-w-[80%] px-[36px] border-[2px] rounded-xl pb-[42px] pt-[52px] bg-white shadow-sm"
      >
        {/* Logo */}
        <div className="flex items-center justify-center scale-150 mb-16">
