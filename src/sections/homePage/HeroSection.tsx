    ...
    <div className="bg-gray-50 xl:h-screen select-none relative">
      <div className="w-full h-full relative xl:flex xl:flex-row container mx-auto px-4">
        <div className="flex  md:text-center xl:text-left items-center xl:items-start flex-1 w-full flex-col relative gap-6 md:gap-10 pt-[270px]">
          <h1 className="text-6xl md:px-16 md:text-7xl xl:px-0 2xl:text-[80px]  leading-none text-wrap uppercase font-extrabold">
            find clothes that matches your style
          </h1>
          <span className="text-black xl:text-left xl:px-0 text-center md:px-[100px] text-base opacity-70 mt-5">
            Browse through our diverse range of meticulously crafted garments,
            designed to bring out your individuality and cater to your sense of
            style.
          </span>
          <Link to={"/collection"} className="mt-6">
            <div className="rounded-full py-4 hover:shadow-2xl transition-all duration-200 bg-black w-[240px] text-white flex items-center justify-center">
              Shop Now
            </div>
          </Link>
